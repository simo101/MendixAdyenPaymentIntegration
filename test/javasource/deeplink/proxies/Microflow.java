...
public class Microflow
{
	 ...
	 */
	public final Boolean getUseStringArg()
	{
	 ...
	 * @return value of UseStringArg
	 */
	public final Boolean getUseStringArg(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (Boolean) getMendixObject().getValue(context, MemberNames.UseStringArg.toString());
	}
	 ...
	 * @param usestringarg
	 */
	public final void setUseStringArg(Boolean usestringarg)
	{
	 ...
	 * @param usestringarg
	 */
	public final void setUseStringArg(com.mendix.systemwideinterfaces.core.IContext context, Boolean usestringarg)
	{
