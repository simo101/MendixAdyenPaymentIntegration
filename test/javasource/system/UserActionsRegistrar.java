...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(adyenintegration.actions.HMAC_Signature.class);
			component.actionRegistry().registerUserAction(adyenintegration.actions.HMAC_Signature_SHA256.class);
			component.actionRegistry().registerUserAction(adyenintegration.actions.PaymentResponseRequestHandler.class);
